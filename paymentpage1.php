...
<nav class="navbar navbar-default" role="navigation">
  ...
  <!--==============================content================================-->
  <img style="float: left;" src="images/image2.jpeg">
  <div style="float: right;">
  	<p class="font-1" style="color: black;">9 Month Unlimited Classes</p>
  	<p class="font-1" style="color:red;">21990</p>
  	
    <a href="func.php">
    	<form class="form-group" method="post" action="checkout1.php">
               
      
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: right; max-width: auto;" type="submit" id="inputbtn" name="submit1" value="Buy Pack" class="btn btn-primary">
  ...
  <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
    ...
    <p class="font-2">Get FREE 2 months extension on the 9-month Cult unlimited pack</p>
    
     <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
     <p class="font-1" style="color:black; font-size: 35px;">About this pack</p>
    <p class="font-2">Book unlimited Classes anytime at any centre in your city for 9 months. </p>
