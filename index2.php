        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="trainer_signup.php">
...
if(isset($_POST['submit'])){
  ...
  $password=$_POST['pwd'];
    ...
    $query="select * from trainer where traineruid='$username' and trainerpwd='$password'";
  $result=mysqli_query($con,$query);


    while($row=mysqli_fetch_array($result)){
        $trainerid=$row ['traineruid'];
        $_SESSION["trainerid"]=$trainerid;
        $traineruid=$row ['trainerid'];
        $_SESSION["traineruid"]=$traineruid;
   ...
   if ($result) {
    ...
    $result=mysqli_query($con,$query);
       ...
       header("location: traineruser.php");
            exit();
     } 
     else {
