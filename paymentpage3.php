...
<nav class="navbar navbar-default" role="navigation">
  ...
  <!--==============================content================================-->
  <img style="float: left;" src="images/image3.jpeg">
  <div style="float: right;">
  	<p class="font-1" style="color: black;">6 Month Select Pack</p>
  	<p class="font-1" style="color:red;">11490</p>
  	
    <a href="func.php">
    	<form class="form-group" action="checkout3.php">
                
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: right; max-width: auto;" type="submit" id="inputbtn" name="submit3" value="Buy Pack" class="btn btn-primary">
  ...
  <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
    ...
    <p class="font-2">6-month Select Pack at Rs. 11490/- instead of Rs. 25950/-</p>
    
     <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
     <p class="font-1" style="color:black; font-size: 35px;">About this pack</p>
    <p class="font-2">Cult Select pack gives you access to one Cult centre selected by you.   </p>
    <p class="font-2">Access to other cult.fit, mind.fit & outdoor centres is not included with this pack. </p>
