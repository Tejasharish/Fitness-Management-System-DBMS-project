...
<div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      ...
      <div class="col-md-8"><input type="text" name="phone" class="form-control" placeholder="phone" required=""></div><br><br>
       <div class="col-md-4"><label>Choose Admin: </label></div>
      <div class="col-md-8"> <select class="form-control" name="admin">

            <?php while($row1 = mysqli_fetch_array($result1)):;?>

            <option value="<?php echo $row1[2];?>"><?php echo $row1[0];?></option>
