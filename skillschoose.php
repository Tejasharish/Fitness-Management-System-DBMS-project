...
$name='Boxing';
   $query1="select * from trainings where training_name='$name' and trainingid='$trainingid'";
     ...
     while ($row=mysqli_fetch_array($result1)){
         ...
         $query2="select * from trainer_skills where trainingid='$trainingid' and trainerid='$id'";
    $result2=mysqli_query($con,$query2);
    if(mysqli_num_rows($result2)!=1){
            
       $query="insert into trainer_skills(trainerid, training_name,trainingid)values('$id','$name','$trainingid')";
