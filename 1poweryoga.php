...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div style="float: right;">
    <p class="font-1" style="color: black;">2 Months Class</p><br><br>
      ...
      <form class="form-group" action="2poweryoga.php">
                
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px;  max-width: auto;" type="submit" id="inputbtn" name="submitt" value="Book Class" class="btn btn-primary">
