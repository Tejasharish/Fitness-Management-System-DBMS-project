...
<nav class="navbar navbar-default" role="navigation">
  ...
  <!--==============================content================================-->
  <img style="padding-left: 150px" src="images/image6.jpeg">
    ...
    <br><br><br>
  	...
  	<hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
        ...
        <div class="row">
                  ...
                  <div class="col-md-8"><input type="text" name="amount" value="15490" class="form-control"  required/></div><br><br>
                  <div class="col-md-4"><label style="color: gray; font-size: 20px;">Total Payable </label></div>
                  <div class="col-md-8"><input type="text" class="form-control" name="amountp" value="15490" required/></div><br><br><br>
                </div>
                
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: right; max-width: auto;" type="submit" id="inputbtn" name="submit6" value="Proceed to pay" class="btn btn-primary">
