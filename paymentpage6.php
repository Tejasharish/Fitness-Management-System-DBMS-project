...
<nav class="navbar navbar-default" role="navigation">
  ...
  <!--==============================content================================-->
  <img style="float: left;" src="images/image6.jpeg">
  <div style="float: right;">
  	<p class="font-1" style="color: black;">10 Months Unlimited Classes</p>
  	<p class="font-1" style="color:red;">15490</p>
  	
    <a href="func.php">
    	<form class="form-group" action="checkout6.php">
                
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: right; max-width: auto;" type="submit" id="inputbtn" name="submit6" value="Buy Pack" class="btn btn-primary">
  ...
  <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
    ...
    <p class="font-2">Get 3 BookMyShow voucher worth Rs. 500 each </p>
    
     <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;">
     <p class="font-1" style="color:black; font-size: 35px;">About this pack</p>
    <p class="font-2">Book unlimited Classes anytime at any mind.fit centre(only) for 10 months </p>
    <p class="font-2">Practice Yoga & Meditation sessions with world-class trainers and leading psychologists in a state-of-the-art mind.fit centre. </p>
