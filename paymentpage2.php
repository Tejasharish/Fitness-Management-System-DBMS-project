...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div style="float: right;">
    ...
    <a href="func.php">
    	<form class="form-group" action="checkout2.php">
                
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: right; max-width: auto;" type="submit" id="inputbtn" name="submit2" value="Buy Pack" class="btn btn-primary">
...
<br>
  ...
  <footer>
    ...
    <p>Website by <a target="_blank" href="#" class="link">I Boys</a></p>
  </footer>
</div>
	</div>
