...
$query = "SELECT * FROM trainer 
 where trainerid in(select trainerid from trainer_skills where training_name='S & C') ";
...
<nav class="navbar navbar-default" role="navigation">
 ...
 <hr style="border: 1px solid rgba(0,0,0,0.7) !important;color: #000000;"></nav>
  ...
  <!--==============================content================================-->
  <img style="float: left;" src="images/s&cc.jpeg">
  <div style="float: right;">
    <p class="font-1" style="color: black;">2 Months Class</p><br><br>
    <?php
    $_SESSION["trainingid"]=7;

    $_SESSION["training_name"]=' S & C';
 ...
 <select class="form-control" name="docapp">
        ...
        <input type="date" name="date" id="sdate" value="<?php echo date('Y-m-d');?>" class="btn btn-warning btn-lg" required/>
                ...
                <input style="margin-right: 30px; margin-top= -20px; background-color: red; font-size: 20px; float: center;  max-width: auto;" type="submit" id="inputbtn" name="s&c" value="Book Class" class="btn btn-primary btn-lg">
